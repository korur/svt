        ...
        <div class="flex justify-between items-center">
            ...
            <ul class="text-sm mt-6 hidden md:block" bind:this={menu} id="menu">
                <li class="text-gray-700 font-bold py-1">
                    <a href="/home" class="px-4 flex flex-wrap justify-center border-r-4 border-red-500">
                        <span>Home</span>
                ...
                <li class="py-1">
                    <a href="/about" class="px-4 flex flex-wrap justify-center border-r-4 border-white">
                        <span>About</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li class="py-1">
                    <a href="/contact" class="px-4 flex flex-wrap justify-center border-r-4 border-white">
                        <span>Contact</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
